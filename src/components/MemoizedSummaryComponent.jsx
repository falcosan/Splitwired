...
const MemoizedSummaryComponent = memo(({ info }) => {
  ...
  return (
    <div className="mt-6 p-4 md:p-6 bg-stone-800 rounded-lg shadow-lg">
      <h2 className="text-xl md:text-2xl font-semibold mb-4 md:mb-6 text-stone-200 flex items-center gap-2">
        Summary
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
        <div className="p-4 md:p-6 bg-stone-700 rounded-lg shadow">
          <p className="text-sm md:text-lg font-medium text-stone-300 mb-2">
            Total Expenses:
          </p>
