...
const DownloadsComponent = ({ downloads, loading }) => {
  ...
  // Assuming downloads is an HTML string
  ...
  // Assuming downloads is an array of objects with href and text
        ...
        <ul>
          {downloads.map((download, index) => (
            <li key={index} className="mb-1">
              <a href={download.href} download className="text-blue-500 hover:underline">
